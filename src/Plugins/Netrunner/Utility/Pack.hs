...
module Plugins.Netrunner.Utility.Pack (toCycle) where

import Plugins.Netrunner.Type.Cycle (Cycle (code))
import Plugins.Netrunner.Type.NrApi (NrApi (cycles))
